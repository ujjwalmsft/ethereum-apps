(function () {
    var databaseInteraction = function ($http, $log) {
        var getContracts = function () {
            return $http.post("xxx/api/getRecords")
        ...
        var addContract = function (contractName, contractAddress, partyA, partyB) {
            var query = "xxx/api/addRecord/" + contractName + "/" + contractAddress + "/" + partyA + "/" + partyB;
        ...
        var updateContract = function (contractAddress, settlementStatus) {
            return $http.post("xxx/api/updateRecord/" + contractAddress + "/" + settlementStatus)
                .then(function (response) {
                    return response;
                })
        };
        ...
        var deleteContract = function (contractAddress) {
            return $http.post("xxx/api/deleteRecord/" + contractAddress)
                .then(function (response) {
                    return response;
                })
        };
