...
namespace AzureFunctionsDemo
{
    ...
    {
        [FunctionName("Demo")]
        public static async Task Run([EventHubTrigger("xxx", Connection = "EventHubConnectionString")]string myEventHubMessage,[Table("xxx", Connection = "TableConnectionString")]ICollector<tableObject> tableBinding, TraceWriter log)
        {
